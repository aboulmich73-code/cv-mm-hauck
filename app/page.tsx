...
const translations = {
  en: {
    ...
    generalLedger: "General Ledger & Bookkeeping",
    accountsPayable: "Accounts Payable / Receivable",
    closings: "Monthly & Annual Closings",
    vat: "VAT Declaration & Payment",
    bank: "Bank & Cash Reconciliations",
    familyAllowances: "Family Allowances (APG)",
    sourceTax: "Source Tax Declarations",
    training: "Training Reimbursement Requests",
    pension: "Occupational Pension (2nd Pillar)",
    payroll: "Payroll Processing",
    sap: "SAP S/4HANA",
    winbiz: "Winbiz & Cresus",
    mfiles: "M-Files, Verifier, CPS",
  ...
  fr: {
    ...
    generalLedger: "Comptabilité générale & Tenue des livres",
    accountsPayable: "Comptes fournisseurs / clients",
    closings: "Clôtures mensuelles & annuelles",
    vat: "Déclaration & Paiement de la TVA",
    bank: "Rapprochements bancaires & caisse",
    familyAllowances: "Allocations familiales (APG)",
    sourceTax: "Déclarations d'impôt à la source",
    training: "Demandes de remboursement de formation",
    pension: "Prévoyance professionnelle (2ème pilier)",
    payroll: "Traitement de la paie",
    sap: "SAP S/4HANA",
    winbiz: "Winbiz & Cresus",
    mfiles: "M-Files, Verifier, CPS",
    excel: "Microsoft Excel (Avancé)",
  },
  de: {
    ...
    administration: "Administration",
    software: "Software & Tools",
    generalLedger: "Hauptbuch & Buchführung",
    accountsPayable: "Kreditoren / Debitoren",
    closings: "Monats- & Jahresabschlüsse",
    vat: "MWST-Deklaration & Zahlung",
    bank: "Bank- & Kassenabstimmungen",
    familyAllowances: "Familienzulagen (APG)",
    sourceTax: "Quellensteuererklärungen",
    training: "Weiterbildungs-Rückerstattungen",
    pension: "Berufliche Vorsorge (2. Säule)",
    payroll: "Lohnverarbeitung",
    sap: "SAP S/4HANA",
    winbiz: "Winbiz & Cresus",
    mfiles: "M-Files, Verifier, CPS",
    excel: "Microsoft Excel (Fortgeschritten)",
  }
};
...
export default function MichaelHauckCV() {
  ...
  return (
    <div className={`min-h-screen ${isDark ? "dark" : ""}`}>
      {/* Navbar - with improved mobile language visibility */}
      <nav className="sticky top-0 z-50 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800">
        ...
        {/* Mobile Menu with very visible language switcher */}
        {isMenuOpen && (
          <div className="md:hidden border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 py-6 px-6">
            <div className="mb-8">
              <p className="text-xs uppercase tracking-widest text-zinc-500 mb-3 text-center">Language / Langue / Sprache</p>
      ...
      {/* Key Competencies - now correctly typed */}
      <section id="skills" className="py-20 bg-white dark:bg-zinc-900">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div>
              <h3 className="font-semibold text-2xl mb-6 text-blue-600">{t.accounting}</h3>
              <ul className="space-y-3 text-zinc-600 dark:text-zinc-400">
                <li>• {t.generalLedger}</li>
                <li>• {t.accountsPayable}</li>
                <li>• {t.closings}</li>
                <li>• {t.vat}</li>
                <li>• {t.bank}</li>
              </ul>
            ...
            <div>
              <h3 className="font-semibold text-2xl mb-6 text-blue-600">{t.administration}</h3>
              <ul className="space-y-3 text-zinc-600 dark:text-zinc-400">
                <li>• {t.familyAllowances}</li>
                <li>• {t.sourceTax}</li>
                <li>• {t.training}</li>
                <li>• {t.pension}</li>
                <li>• {t.payroll}</li>
            ...
            <div>
              <h3 className="font-semibold text-2xl mb-6 text-blue-600">{t.software}</h3>
              <ul className="space-y-3 text-zinc-600 dark:text-zinc-400">
                <li>• {t.sap}</li>
                <li>• {t.winbiz}</li>
                <li>• {t.mfiles}</li>
      ...
      {/* Formation, Experience, Contact sections remain the same as previous full version */}
      {/* (I kept them short here for brevity, but they are the same as the last full file I sent you) */}
